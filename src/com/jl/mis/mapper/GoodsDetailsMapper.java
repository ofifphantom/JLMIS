...
public interface GoodsDetailsMapper extends BaseMapper<GoodsDetails>{
	 ...
	 * @return
	 */
	public List<GoodsDetails> selectGoodsByClassificationId(Integer classificationId);
	 ...
	 * @return
	 */
	public List<GoodsDetails> getHomeHotGoods(Map<String,Object> map);
	/**
	 * 查询app中的新品上架商品list 
	 * @param map
	 * @return
	...
	public List<GoodsDetails> getGoodsList_Ameliorate(Map<String,Object> map);
	/**
	 * 根据商品id获取商品的信息以及有关商品的评价信息
	 * @param map
	 * @return
	 */
	public GoodsDetails getGoodsDetailAndEvaluationByGoodsId(Map<String,Object> map);
