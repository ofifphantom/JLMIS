 ...
 */
public interface ActivityInformationMapper extends BaseMapper<ActivityInformation>{
	/**
	 * 根据id列表删除活动信息
	 * @param list id列表
	 ...
	 * @return
	 */
	public List<ActivityInformation> selectMsgOrderBySearchMsg(Map<String,Object> map);
	 ...
	 * @return List<AcivityInformation>
	 */
	public List<ActivityInformation> getAllReadyToOnlineActivityInformation();
...
//	 */
//	public void updateActivityInformationToOnline();
	/**
