(function(a) {
	a.easyPieChart = function(d, l) {
		...
		this.init = function() {
			...
			h.percentage = 0;
			h.canvas = a("<canvas width='" + h.options.size + "' height='"
					+ h.options.size + "'></canvas>").get(0);
		...
		f = function(m) {
			...
			h.ctx.fillRect(h.options.size / 2 - n, 0, -h.options.size * 0.05
							+ n, 1);
			h.ctx.restore()
		};
		b = function() {
		...
		i = function(m) {
			var n;
			k();
			h.ctx.strokeStyle = a.isFunction(h.options.barColor) ? h.options
					.barColor(m) : h.options.barColor;
		...
		c = (function() {
			return window.requestAnimationFrame
					...
					|| window.mozRequestAnimationFrame || function(m) {
		...
		g = function(p, o) {
			...
			n = function() {
				...
				h.ctx.clearRect(-h.options.size / 2, -h.options.size / 2,
						h.options.size, h.options.size);
				k.call(h);
