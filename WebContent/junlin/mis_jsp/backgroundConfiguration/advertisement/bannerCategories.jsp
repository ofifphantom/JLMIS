...
<html lang="en">
			...
			<div id="Member_Ratings">
				<div class="d_Confirm_Order_style" style="margin-top:10px;">
					...
					<div class="opration-div clearfix">
						<span class="r_f"> 
							<button type="button" class="btncss jl-btn-defult" onclick="categoriesEduce()" style="margin-right: 0;"><i class="fa fa-download"></i> 导出</button>
							
						</span>
						<span class="r_f"> 
							<button type="button" class="btncss jl-btn-defult" onclick="categoriesDel()"><i class="fa fa-trash"></i> 删除</button>
						</span>
						<span class="r_f"> 
							<button type="button" class="btncss jl-btn-importent" onclick="categoriesAdd()"><i class="fa fa-plus"></i> 新增</button>
						</span>
						<span class="jl_f_l">
		...
		<div id="editDiv" style="display: none;">
			<form class="container" id="inserOrUpdateDiv">
				<div class="form-group">
					...
					<input type="text" class="hidden" id="type" name="type" value="2"/>
					<div class="col-xs-4">
						分类广告
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-xs-6">
						<input type="text" class="form-control" id="name"  name="name" maxlength="100" placeholder="请输入分类广告图名称" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-xs-2"></div>
				...
				<div class="col-xs-8 tip">注：<br/>1.上传的图片大小应小于2M,图片尺寸建议为1000*400（单位：像素）<br/>
				2.该页面所有字段均为必填</div>
				</div>
			</form>
		</div>
			...
			.dataTable({
				...
				"aoColumns": [{
						...
						"mRender": function(data, type, row) {
							...
							return '<td><input type="button" class="btncss edit" onclick=\'categoriesEffect(this,'+ JSON.stringify(row) +')\' value="生效" /></td>';
						}
					}
	...
	$.ajax({
		...
		/*生效*/
		function categoriesEffect(thisbtn,data) {
